...
public class SecurityConfig {
    ...
    CorsConfigurationSource corsConfigurationSource(){
        ...
        private static final String SECRET_KEY = "3cHvF2nS5rV1uY7xAbEeH2gK5jN6p3sQ";
        ...
        JwtDecoder jwtDecoder() {
            // Create a SecretKey instance from the secret key bytes (HMAC-SHA512)
        ...
        //            SecretKey secretKey = new SecretKeySpec(SECRET_KEY.getBytes(), "RSA");
        //            // Configure the NimbusJwtDecoder with the SecretKey and HMAC-SHA256 algorithm
        //            return NimbusJwtDecoder.withSecretKey(secretKey)
        //                    .macAlgorithm(MacAlgorithm.HS512)
        //                    .build();
        //        }
